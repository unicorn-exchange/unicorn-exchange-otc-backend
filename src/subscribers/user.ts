...
//   public onUserSignIn({id}: Partial<IUserRecord>) {
//     const Logger = Container.get("logger");
//
//     try {
//       const UserModel = Container.get("UserModel") as mongoose.Model<IUserRecord & mongoose.Document>;
//
//       UserModel.update({id: id}, {$set: {lastLogin: new Date()}});
//     } catch (e) {
...
//   public onUserSignUp({name, email, id}: Partial<IUserRecord>) {
//     const Logger = Container.get("logger");
//
//     try {
//       /**
